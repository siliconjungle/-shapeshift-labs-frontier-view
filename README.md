...
The benchmark covers manifest creation, frame materialization, field/action/path queries, impact tracing, registry graph generation, JSONL round trip, redaction, and proof generation using Frontier-only package measurements. It does not include competitor comparisons.
